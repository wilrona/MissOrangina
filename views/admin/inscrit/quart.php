...
<div class="wrap">
    ...
    <h2>Les inscrits en quart de final</h2>
    ...
    <form id="persons-table" method="POST">
        ...
        <?php
        $table = $this->list_view("List_View_Inscrit_Quart");
        ...
        <ul class="subsubsub" style="float: right; margin-right: 70px;">
            <li class="all"><strong>Etat des candidats en 1/4 de final</strong> :</li>
            <li class="all"><a href="/etat/listeinscrit?phase=2" target="_blank" >Tous</a> |</li>
            <li class="all"><a href="/wp-admin/admin-ajax.php?phase=2&amp;action=ville&amp;width=750&amp;height=300" class="thickbox">Par ville</a> |</li>
            <li class="all"><a href="/wp-admin/admin-ajax.php?phase=2&amp;action=age&amp;width=750&amp;height=300" class="thickbox">Par age</a> </li>
            <li class="all" style="margin-left: 20px;"><strong>Classement</strong> :</li>
            <li class="all"><a href="/etat/classement?phase=2" target="_blank">General</a> |</li>
            <li class="all"><a href="/wp-admin/admin-ajax.php?phase=2&amp;action=ville&amp;width=750&amp;height=300&amp;classement=1" class="thickbox">Par Ville</a></li>
        </ul>
